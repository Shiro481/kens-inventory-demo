...
ALTER TABLE "public"."variant_definitions" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."variant_definitions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE "public"."variant_categories" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."variant_categories_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."product_variants"
    ADD CONSTRAINT "product_variants_product_id_bulb_type_color_temperatur_key" UNIQUE ("product_id", "bulb_type", "color_temperature");
...
-- Trigger removed to prevent unintentional parent stock zeroing
...
ALTER TABLE ONLY "public"."products"
    ADD CONSTRAINT "products_variant_type_id_fkey" FOREIGN KEY ("variant_type_id") REFERENCES "public"."variant_categories"("id");
...
CREATE POLICY "Public Access" ON "public"."variant_definitions" USING (true);



CREATE POLICY "Public Access" ON "public"."variant_categories" USING (true);



CREATE POLICY "Public Access" ON "public"."product_variants" USING (true);
...
CREATE POLICY "Public Read ProductVariants" ON "public"."product_variants" FOR SELECT USING (true);
...
CREATE POLICY "Public Write ProductVariants" ON "public"."product_variants" USING (true) WITH CHECK (true);
...
GRANT ALL ON SEQUENCE "public"."variant_definitions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."variant_definitions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."variant_definitions_id_seq" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."variant_categories_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."variant_categories_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."variant_categories_id_seq" TO "service_role";
