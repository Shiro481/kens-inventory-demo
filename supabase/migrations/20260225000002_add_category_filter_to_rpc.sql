-- ============================================================
-- Migration: Add p_categories filter to search_inventory RPC
-- Allows server-side filtering by category so the inventory
-- table can show ALL items in a category (not just the first 50).
-- ============================================================
...
BEGIN
  ...
  WHERE 
    -- Category filter (exact match on any of the provided categories)
