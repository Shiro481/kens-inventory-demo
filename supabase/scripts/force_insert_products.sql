-- =====================================================
-- FORCE INSERT/UPDATE PRODUCTS
-- =====================================================
-- This will INSERT new products or UPDATE existing ones

-- First, let's check what we currently have
SELECT 'Current Products Count:' as info, COUNT(*) as count FROM products;

-- Insert or update products with ON CONFLICT DO UPDATE
...
('GPNE-H4-LED-001', '1234567890123', 'GPNE H4 LED Headlight Conversion Kit', 'GPNE', 
 ...
 '{"color": "6000K White", "lifespan": "50000 hours", "warranty": "2 years", "cooling": "Fan", "compatible": "H4"}'),
...
('GPNE-H7-LED-002', '1234567890124', 'GPNE H7 LED Headlight Bulbs (Pair)', 'GPNE', 
 ...
 '{"color": "6500K Cool White", "lifespan": "45000 hours", "warranty": "2 years", "compatible": "H7"}'),
...
('PHILIPS-H4-001', '2345678901234', 'Philips H4 Standard Halogen Headlight', 'Philips', 
 ...
 '{"color": "3200K Warm White", "lifespan": "450 hours", "warranty": "1 year", "compatible": "H4"}'),
...
('OSRAM-9005-001', '3456789012345', 'Osram 9005 Silverstar High Beam', 'Osram', 
 ...
 '{"color": "3700K Bright White", "lifespan": "400 hours", "warranty": "1 year", "compatible": "9005/HB3"}'),
...
('D2S-XENON-001', '9012345678901', 'D2S HID Xenon Headlight Bulb', 'Aftermarket', 
 ...
 '{"color": "4300K White", "lifespan": "2500 hours", "warranty": "1 year", "ballast_required": true, "compatible": "D2S"}'),
...
('GPNE-UNI-LED-001', '9988776655443', 'GPNE Universal LED Headlight Kit', 'GPNE', 
 ...
 '{"color": "6500K Cool White", "lifespan": "60000 hours", "warranty": "3 years", "adapters": "H4/H7/9005/9006", "canbus": true, "cooling": "Turbo Fan", "brightness": "9000 lumens", "compatible": "H4/H7/9005/9006"}'),
...
ON CONFLICT (sku) DO UPDATE SET
    ...
    bulb_type_id = EXCLUDED.bulb_type_id,
...
-- Set supplier references to NULL
...
-- Final verification
SELECT 'After Insert/Update:' as info, COUNT(*) as count FROM products;
...
SELECT 
    ...
    CASE 
        ...
        ELSE specifications->>'color'
    END as display_info
FROM products 
WHERE brand IN ('GPNE', 'Philips', 'Osram', 'Aftermarket')
ORDER BY brand, name
LIMIT 15;
