-- =====================================================
-- COMPLETE SCHEMA DEPLOYMENT (SAFE SYNC)
-- =====================================================
...
CREATE TABLE IF NOT EXISTS products (
    ...
    voltage numeric,
    wattage numeric,
    color_temperature text, -- Changed to text to support string values like '6000K'
    lumens numeric,
    beam_type text,
...
SELECT 'Full Schema Deployed Successfully' as status;
